...
// A layered-planes glyph; doubles as the generic `default` since both read as "stacked".
const stackedPlanes = "M12 2 2 7l10 5 10-5-10-5Z M2 17l10 5 10-5 M2 12l10 5 10-5";

export const showcaseIcons: Record<string, string> = {
  default: stackedPlanes,
  layers: stackedPlanes,
  target:
    "M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0 M12 12m-2.5 0a2.5 2.5 0 1 0 5 0a2.5 2.5 0 1 0 -5 0",
  ...
  range:
    "M3 12h18 M9 12m-2.4 0a2.4 2.4 0 1 0 4.8 0a2.4 2.4 0 1 0 -4.8 0 M15 12m-2.4 0a2.4 2.4 0 1 0 4.8 0a2.4 2.4 0 1 0 -4.8 0",
...
export function iconPath(key?: string): string {
  return (key && showcaseIcons[key]) || stackedPlanes;
}
